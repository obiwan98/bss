            ...
            return (
              <List.Item key={item._id}>
                ...
                <div className="bookData-body">
                  ...
                  <div className="rate-tag-form">
                    <div className="rate-content">
                      <Rate value={rate} count={1} allowHalf disabled />
                    ...
                    {tagData && (
                      <>
                        ...
                        <div className={`tag-content ${tagData.class}`}>
                          <span className="tag-icon">{tagData.icon}</span>
                          <span className="tag-text">{tagData.text}</span>
                        </div>
                      </>
                    )}
                  </div>
                ...
                <div className="bookData-footer">
                  <Space>
                    <Button type="primary" onClick={() => handleShowModal('detailView', item)}>
                      수정
                    </Button>
